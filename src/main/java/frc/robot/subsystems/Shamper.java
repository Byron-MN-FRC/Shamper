...
private double gearRatioNeo550 = maxRPMNeo550 / 7;
...
topRight.burnFlash();
    ...
    public void runAll() {
        ...
        bottomLeft.set((SmartDashboard.getNumber("BL-RPM", defaultRPM) / gearRatioNeo550) * neo550CorrectionFactor);
        bottomRight.set((SmartDashboard.getNumber("BR-RPM", defaultRPM) / gearRatioNeo550) * neo550CorrectionFactor);
